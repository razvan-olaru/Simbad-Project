...
public class Coordinates  {
    ...
    public Coordinates (Point3d coords) {
        getCoordinatesofX(coords);
        getCoordinatesofY(coords);
    }
    ...
    private void getCoordinatesofX (Point3d coords){
        x = (int) coords.z + 11;
	...
	More than that, it transforms it from a value in the range [0, 23] to 
	an int in the range [0, 46] in order to fit the database 46x46 matrix */
    private void getCoordinatesofY(Point3d coords){
        y = (int) coords.x + 11;
